IMPORTANT: To prevent a duplication bug when placing waystones in protected areas, run this command: 
function pk_waystones:settings/lootable_delay/set {delay:1}
